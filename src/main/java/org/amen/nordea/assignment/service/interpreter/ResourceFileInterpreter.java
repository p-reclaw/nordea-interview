...
public class ResourceFileInterpreter implements IInterpreter {

    private final String resourcePath;
    private final ClassLoader classLoader;

    public ResourceFileInterpreter(String resourcePath) {
        this(resourcePath, Thread.currentThread().getContextClassLoader());
    }

    public ResourceFileInterpreter(String resourcePath, ClassLoader classLoader) {
