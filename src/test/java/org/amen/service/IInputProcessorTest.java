...
class IInputProcessorTest {

    private final IInputProcessor processor = new TestInputProcessor();

    private static class TestInputProcessor implements IInputProcessor {
        @Override
